...
const CardItem = ({ card }) => {
    ...
    return (
        <div className="lg:w-[460px]  lg:h-[400px]  rounded-xl shadow-md transition lg:p-0 lg:mx-0 mx-4 ease-in-out delay-150  lg:hover:-translate-y-1 lg:hover:scale-105 cursor-pointer  duration-300">
